...
export const sellerAction = (token) => (dispatch) => {
  axios
    .get(
      "https://bealterracapstone-production.up.railway.app/api/v1/myproducts?page=1",
      {
...
export const orderSellerDiminati = (token) => (dispatch) => {
  axios
    .get(
      "https://bealterracapstone-production.up.railway.app/api/v1/sales?page=1",
      {
        headers: { Authorization: `Bearer ${token}` },
      }
    )
...
export const orderSellerTerjual = (token) => (dispatch) => {
  axios
    .get(
      "https://bealterracapstone-production.up.railway.app/api/v1/myproducts?page=1&row=10&status=false",
      {
        headers: { Authorization: `Bearer ${token}` },
      }
    )
...
export const orderSellerDibatalkan = (token) => (dispatch) => {
  axios
    .get(
      "https://bealterracapstone-production.up.railway.app/api/v1/sales?page=1&row=12&done=0",
      {
        headers: { Authorization: `Bearer ${token}` },
      }
    )
...
export const orderSellerBerhasil = (token) => (dispatch) => {
  axios
    .get(
      "https://bealterracapstone-production.up.railway.app/api/v1/sales?page=1&row=12&done=1",
      {
        headers: { Authorization: `Bearer ${token}` },
      }
    )
...
export const orderSellerDiproses = (token) => (dispatch) => {
  axios
    .get(
      "https://bealterracapstone-production.up.railway.app/api/v1/sales?page=1&row=12&status=1",
      {
        headers: { Authorization: `Bearer ${token}` },
      }
    )
