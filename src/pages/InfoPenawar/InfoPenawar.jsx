...
const InfoPenawar = () => {
  ...
  // const tanggal = (date) => {
  //   const hari = date.slice(0, 10);
  //   const jam = date.slice(12,19);
  //   return hari + jam
  // };

  // `${tanggal(dataOrderSeller?.createdAt)}`
		...
		<>
			...
			<div className={style.container}>
				...
				<div className={style.content}>
					...
					{(dataOrderSeller?.status === 1 && dataOrderSeller?.is_done === null) && (
					...
					{(dataOrderSeller?.status === null && dataOrderSeller?.is_done === null) && (
						<div className={style.btnContainer}>
					...
					{(dataOrderSeller?.status === 0 && dataOrderSeller?.is_done === null) && (
						<div className={style.btnContainer}>
							<p>Pesanan Ditolak</p>
						</div>
					)}{" "}
					{dataOrderSeller?.is_done !== null && (
						<div className={style.btnContainer}><p>Pesanan Selesai</p></div>
					)}
					<hr />
				</div>
			</div>
